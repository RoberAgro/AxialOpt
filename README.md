...
If you want to cite AxialOpt in a scientific publication, please refer to the [Zenodo repository](https://doi.org/10.5281/zenodo.2616406) listed in the references below and use the DOI (permanent link).
