...
fluid = 'R125';                                                            % Name used by REFPROP
...
p0_in = 3618.0;                                                            % Inlet stagnation pressure in (kPa)
h0_in = refpropm('h','T',T0_in,'p',p0_in,fluid);                           % Inlet stagnation enthalpy in (J/kg)   
p_out = 1568.5;                                                            % Outlet static pressure in (Pa)
...
AR = 2.50;                                                                 % Diffuser area ratio (set a value close to one for the no-diffuser case)
