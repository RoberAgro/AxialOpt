function [] = AxialOpt_plot_view_axial_radial_diffuser(turbine_data,my_filename,my_path,save)
...
% casing_x = casing_x(1:end-1);
% casing_y = casing_y(1:end-1);
...
% Save the figure
name = '_view_axial_radial_diffuser';
