function [] = AxialOpt_plot_view_axial_tangential(turbine_data,my_filename,my_path,save)
%% Axial-Tangential view of the axial turbine
...
for j = 1:n_cascades
    ...
    [x,y] = AxialOpt_plot_view_blade(blade_parameters);
