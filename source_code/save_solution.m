...
fprintf(file_name,'|-------------------------------------------------------------------------------------------------------------|\n');
fprintf(file_name,'|-------------------------------- Values and limits of the problem constraints -------------------------------|\n');
fprintf(file_name,'|-------------------------------------------------------------------------------------------------------------|\n');
fprintf(file_name,'%26s %15s %12s %15s %12s %10s \n', header{1}, header{2}, header{3}, header{4}, header{5}, header{6});
for i = 1:size(name,2)
    fprintf(file_name,'%26s %15.4f %12.4f %15.4f %12s %10s \n', name{i}, value_min{i}, value{i}, value_max{i}, satisfied{i}, active{i});
end
fprintf(file_name,'|-------------------------------------------------------------------------------------------------------------|\n');
...
fprintf(file_name,'|-------------------------------------------------------------------------------------------------------------|\n');
fprintf(file_name,'%26s %15s %12s %15s %10s %12s %10s \n', header{1}, header{2}, header{3}, header{4}, header{5}, header{6}, header{7});
for i = 1:size(name,2)
    if strcmp(name{i}, 'Angular speed (RPM)')
        fprintf(file_name,'%26s %15.1f %12.1f %15.1f %10s %12s %10s \n', name{i}, value_min{i}, value{i}, value_max{i}, applied{i}, satisfied{i}, active{i});
    else
        fprintf(file_name,'%26s %15.4f %12.4f %15.4f %10s %12s %10s \n', name{i}, value_min{i}, value{i}, value_max{i}, applied{i}, satisfied{i}, active{i});
    end
end
fprintf(file_name,'|-------------------------------------------------------------------------------------------------------------|\n');
fclose(file_name);
