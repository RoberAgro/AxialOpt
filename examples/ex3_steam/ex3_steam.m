...
AR = 2.500;                                                                % Diffuser area ratio (set a value close to one for the no-diffuser case)
...
% Aspect ratio
r_Hc(1:2*n_stages) = 3.50;                                                 % Ratio of the mean blade height to the actual chord (not axial chord)
r_Hc_min(1:2*n_stages) = 3.00;                                             % Saravanamuttoo advises against aspect ratios lower than 1.00
r_Hc_max(1:2*n_stages) = 4.00;                                             % Saravanamuttoo indicates that high values may leed to vibration problems and that values around 3.00-4.00 are safe
...
% Hub-to-tip ratio
constraints.r_ht.min = 0.500;                                              % Kacker-Okapuu correlation holds for values as low as 0.500. Saravanamuttoo discusses ratios as low as 0.50.
