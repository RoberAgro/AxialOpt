...
% Aspect ratio
r_Hc(1:2*n_stages) = 3.50;                                                  % Blade height to actual chord aspect ratio (not axial chord)
r_Hc_min(1:2*n_stages) = 3.00;                                             % Saravanamuttoo advises against aspect ratios lower than 1.00
r_Hc_max(1:2*n_stages) = 4.00;                                             % Saravanamuttoo indicates that high values may leed to vibration problems. Values around 3.00-4.00 are safe
